...
<body>
    <div class="login-container">
        ...
        <div class="info">
            <p>Kiểm tra thông tin đăng nhập của người dùng gồm: Email name, Password, Mã số, nếu khớp với thông tin người dùng trong tập tin users.ini thì tạo cookie lưu lại thông tin đăng nhập.</p>
            <p>Sau khi người dùng đăng nhập thành công, duy trì việc đăng nhập này trong 3 phút, quá thời gian này, tự động đăng xuất người dùng.</p>
        </div>
        <div class="result">
            <?php
